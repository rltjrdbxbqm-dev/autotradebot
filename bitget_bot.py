...
TRADING_CONFIGS = [
    {
        ...
        # 롱 파라미터 (우선)
        'long_ma': 344, 'long_sk': 34, 'long_sks': 29, 'long_sd': 15, 'long_lev': 5,
        # 숏 파라미터 (보조)
        'short_ma': 259, 'short_sk': 47, 'short_sks': 26, 'short_sd': 10, 'short_lev': 3,
    },
    {
        'enabled': True,
        'symbol': 'ETHUSDT',
        ...
        # 롱 파라미터 (보조)
        'long_ma': 151, 'long_sk': 48, 'long_sks': 29, 'long_sd': 11, 'long_lev': 5,
        # 숏 파라미터 (우선)
        'short_ma': 226, 'short_sk': 148, 'short_sks': 45, 'short_sd': 29, 'short_lev': 1,
    },
    {
        'enabled': True,
        'symbol': 'XRPUSDT',
        ...
        'priority': 'short',  # 숏우선 (Winner: SF)
        # 롱 파라미터 (보조)
        'long_ma': 112, 'long_sk': 17, 'long_sks': 12, 'long_sd': 13, 'long_lev': 4,
        # 숏 파라미터 (우선)
        'short_ma': 199, 'short_sk': 115, 'short_sks': 16, 'short_sd': 46, 'short_lev': 1,
    },
    {
        'enabled': True,
        'symbol': 'SOLUSDT',
        ...
        'priority': 'long',  # 롱우선 (Winner: LF)
        # 롱 파라미터 (우선)
        'long_ma': 75, 'long_sk': 39, 'long_sks': 25, 'long_sd': 12, 'long_lev': 3,
        # 숏 파라미터 (보조)
        'short_ma': 243, 'short_sk': 39, 'short_sks': 28, 'short_sd': 50, 'short_lev': 2,
    },
    {
        'enabled': True,
        'symbol': 'DOGEUSDT',
        ...
        'priority': 'long',  # 롱우선 (Winner: LF)
        # 롱 파라미터 (우선)
        'long_ma': 252, 'long_sk': 17, 'long_sks': 43, 'long_sd': 27, 'long_lev': 2,
        # 숏 파라미터 (보조)
        'short_ma': 101, 'short_sk': 81, 'short_sks': 28, 'short_sd': 16, 'short_lev': 3,
    },
    {
        'enabled': True,
        'symbol': 'ADAUSDT',
        ...
        'priority': 'long',  # 롱우선 (Winner: LF)
        # 롱 파라미터 (우선)
        'long_ma': 93, 'long_sk': 28, 'long_sks': 43, 'long_sd': 12, 'long_lev': 3,
        # 숏 파라미터 (보조)
        'short_ma': 246, 'short_sk': 21, 'short_sks': 25, 'short_sd': 34, 'short_lev': 2,
    },
]
